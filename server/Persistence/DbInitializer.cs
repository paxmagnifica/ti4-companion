        ...
        public static void Initialize(SessionContext context)
        {
            ...
            if (context.Explorations.FirstOrDefault(e => e.Slug == "demilitarized-zone" && e.GameVersion == GameVersion.PoK) == null)
            {
                var explorations = new Exploration[]
                {
                    ...
                    new Exploration("biotic-research-facility", GameVersion.PoK, PlanetType.Industrial, 1, 1, 1, Technology.Biotic),
                    new Exploration("cybernetic-research-facility", GameVersion.PoK, PlanetType.Industrial, 1, 1, 1, Technology.Cybernetic),
                    ...
                    new Exploration("propulsion-research-facility", GameVersion.PoK, PlanetType.Industrial, 1, 1, 1, Technology.Propulsion),
                    ...
                    new Exploration("warfare-research-facility", GameVersion.PoK, PlanetType.Hazardous, 1, 1, 1, Technology.Warfare),
