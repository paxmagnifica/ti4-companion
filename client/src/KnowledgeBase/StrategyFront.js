...
function StrategyFront({
  ...
  const classes = useStyles({ width: actualWidth, height: actualHeight, fontScale })
  ...
  return <div className={classes.container}>
    ...
    <div className={clsx(classes.mask, classes.card, classes.name1, strategy)} />
    <div className={clsx(classes.mask, classes.card, classes.primary1, strategy)} />
    <div className={clsx(classes.mask, classes.card, classes.primary2, strategy)} />
    <div className={clsx(classes.mask, classes.card, classes.primary3, strategy)} />
