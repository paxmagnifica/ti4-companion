export const en = {
  ...
  'dyson-sphere': {
    ...
    title: 'Dyson Sphere',
    effect:
      "ATTACH: This planet's resource value is increased by 2 and its influence value is increased by 1.",
  },
  freelancers: {
    slug: 'freelancers',
    title: 'Freelancers',
  ...
  'tomb-of-emphidia': {
    slug: 'tomb-of-emphidia',
    title: 'Tomb of Emphidia',
    effect:
      'ATTACH: This planet\'s influence value is increased by 1. If the player who has the "Crown of Emphidia" Relic has control of this planet, they can use that relic to gain 1 Victory Point.',
  },
  'cultural-relic-fragment': {
    slug: 'cultural-relic-fragment',
    title: 'Cultural Relic Fragment',
    effect: 'ACTION: Purge 3 of your cultural relic fragments to gain 1 Relic.',
  },
  'abandoned-warehouses': {
    slug: 'abandoned-warehouses',
  ...
  'biotic-research-facility': {
    slug: 'biotic-research-facility',
    title: 'Biotic Research Facility',
    effect:
      "ATTACH: This planet has a green technology specialty; if this planet already has a technology specialty, this planet's resource and influence values are each increased by 1 instead.",
  },
  'cybernetic-research-facility': {
    slug: 'cybernetic-research-facility',
    title: 'Cybernetic Research Facility',
    effect:
      "ATTACH: This planet has a yellow technology specialty; if this planet already has a technology specialty, this planet's resource and influence values are each increased by 1 instead.",
  },
  'functioning-base': {
    slug: 'functioning-base',
    title: 'Functioning Base',
    effect:
      'You may gain 1 commodity, or you may spend 1 trade good or 1 commodity to draw 1 action card.',
  },
  'local-fabricators': {
    slug: 'local-fabricators',
  ...
  'propulsion-research-facility': {
    slug: 'propulsion-research-facility',
    title: 'Propulsion Research Facility',
    effect:
      "ATTACH: This planet has a blue technology specialty; if this planet already has a technology specialty, this planet's resource and influence values are each increased by 1 instead.",
  },
  'industrial-relic-fragment': {
    slug: 'industrial-relic-fragment',
  ...
  'lazax-survivors': {
    slug: 'lazax-survivors',
    title: 'Lazax Survivors',
    effect:
      "ATTACH: This planet's resource value is increased by 1 and its influence value is increased by 2.",
  },
  'mining-world': {
    slug: 'mining-world',
    title: 'Mining World',
  ...
  'warfare-research-facility': {
    slug: 'warfare-research-facility',
    title: 'Warfare Research Facility',
    effect:
      "ATTACH: This planet has a red technology specialty; if this planet already has a technology specialty, this planet's resource and influence values are each increased by 1 instead.",
  },
  'hazardous-relic-fragment': {
    slug: 'hazardous-relic-fragment',
    title: 'Hazardous Relic Fragment',
    effect:
      'ACTION: Purge 3 of your hazardous relic fragments to gain 1 Relic.',
  },
  'derelict-vessel': {
    slug: 'derelict-vessel',
    title: 'Derelict Vessel',
    effect: 'Draw 1 secret objective.',
  },
  'enigmatic-device': {
    slug: 'enigmatic-device',
    title: 'Enigmatic Device',
    effect:
      'Place this card face up in your play area. ACTION: You may spend 6 resources and purge this card to research 1 technology.',
  },
  'gamma-relay': {
    slug: 'gamma-relay',
    title: 'Gamma Relay',
  ...
  'ion-storm': {
    ...
    title: 'Ion Storm',
    effect:
      'Place the ion storm token in this system with either side face up. Then, place this card in the common play area. At the end of a "Move Ships" or "Retreat" sub-step of a tactical action during which 1 or more of your ships use the ion storm wormhole, flip the ion storm token to its opposing side.',
  },
  'lost-crew': {
    slug: 'lost-crew',
    title: 'Lost Crew',
