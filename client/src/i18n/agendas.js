export const en = {
  'anti-intellectual-revolution': {
    slug: 'anti-intellectual-revolution',
  ...
  'classified-document-leaks': {
    slug: 'classified-document-leaks',
    title: 'Classified Document Leaks',
    election: 'ScoredSecretObjective',
    effect:
      'When this agenda is revealed, if there are no scored secret objectives, discard this card and reveal another agenda from the top of the deckThe elected secret objective becomes a public objective; place it near the other public objectives in the common play area.',
  },
  'committee-formation': {
    slug: 'committee-formation',
  ...
  'publicize-weapon-schematics': {
    slug: 'publicize-weapon-schematics',
  ...
  'representative-government-base': {
    slug: 'representative-government-base',
  ...
  'the-crown-of-thalnos': {
    slug: 'the-crown-of-thalnos',
    title: 'The Crown of Thalnos',
    election: 'Player',
    effect:
      'The elected player gains this card.During each combat round, the owner of this card may reroll any number of dice; they must destroy each of their units that did not produce a hit with its reroll. (Typo: The card itself says "The Crown of Thanlos," but rules referring to it use the correct title.)',
  },
  'wormhole-reconstruction': {
    slug: 'wormhole-reconstruction',
  ...
  'judicial-abolishment': {
    slug: 'judicial-abolishment',
    title: 'Judicial Abolishment',
    election: 'Law',
    effect:
      'When this agenda is revealed, if there are no laws in play, discard this card and reveal another agenda from the top of the deck. Discard the elected law from play.',
  },
  'miscount-disclosed': {
    slug: 'miscount-disclosed',
  ...
  'checks-and-balances': {
    ...
    election: '-',
    effect:
      'FOR : When a player chooses a strategy card during the strategy phase, they give that strategy card to another player that does not have one (or a player that does not have two in a 3 or 4 playergame), if able\nAGAINST : Each player readies only 3 of their planets at the end of this agenda phase',
  },
  'nexus-sovereignty': {
    slug: 'nexus-sovereignty',
    title: 'Nexus Sovereignty',
    election: '-',
    effect:
  ...
  'representative-government-pok': {
    slug: 'representative-government-pok',
    title: 'Representative Government',
    election: '-',
    effect:
  ...
  'armed-forces-standardization': {
    slug: 'armed-forces-standardization',
    title: 'Armed Forces Standardization',
    election: 'Player',
    effect:
  ...
  'covert-legislation': {
    slug: 'covert-legislation',
    title: 'Covert Legislation',
    election: '-',
    effect:
  ...
  'galactic-crisis-pact': {
    slug: 'galactic-crisis-pact',
    title: 'Galactic Crisis Pact',
  ...
  'minister-of-antiques': {
    slug: 'minister-of-antiques',
    title: 'Minister of Antiques',
    election: 'Player',
    effect: 'The elected player gains 1 relic',
  },
  'rearmament-agreement': {
    slug: 'rearmament-agreement',
    title: 'Rearmament Agreement',
    election: '-',
    effect:
  ...
  'research-grant-reallocation': {
    slug: 'research-grant-reallocation',
    title: 'Research Grant Reallocation',
    election: 'Player',
    effect:
